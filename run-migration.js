...
client.connect()
  ...
  .then(() => {
    ...
    console.log('   Created tables: clients, projects, responses, suppliers, supplier_project_links');
    console.log('   Added project columns: is_multi_country, country_urls, oi_prefix, client_pid_param, client_uid_param, uid_params');
    console.log('   Created RPC function: increment_quota (atomic quota management)');
